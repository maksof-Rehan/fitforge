...
function renderDay(){
  ...
  day.exercises.forEach((ex,idx)=>{
    ...
    if(ex.custom)vids+=`<button class="vid-btn rm" data-rm="${idx}">🗑 Remove</button>`;else vids+=`<button class="vid-btn swap" data-alt="${idx}">🔀 Ways to train (${EX_POOL[ex.cat].length})</button>`;
